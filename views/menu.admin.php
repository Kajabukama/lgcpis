		...
		<div class="ui container">
			<?php
				if(Session::exists('userid')){
					...
					echo "<a href='view-officers?userid={$userid}&view=view-officers' class='{$view_officers} item'><i class='users icon'></i> Officers</a>";

					echo "<a href='view-topics?userid={$userid}&view=topics' class='{$topics} item'><i class='users icon'></i> Topics</a>";

					echo "<a href='view-citizens?userid={$userid}&view=citizens' class='{$citizens} item'><i class='users icon'></i> Citizens</a>";
